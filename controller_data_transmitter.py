...
# Ce script utilise Pygame pour interagir avec une manette connectée au PC.
# Les données des axes et boutons de la manette sont lues et envoyées au serveur
# sous forme de JSON via une connexion socket TCP.
# et envoie les données toutes les 0,1 seconde.
