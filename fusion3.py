...
seuil_joystick_sup = 0.7
seuil_joystick_inf = -0.7
...
# moteur arriere
        ...
        elif current_axes[1] < seuil_joystick_inf:
            dt_value[0] += acceleration

        if dt_value[0] <= vitesse_min:
            print("valeur min atteint")
        elif current_axes[1] > seuil_joystick_sup:
            dt_value[0] -= freinage
...
#Direction gauche 
        ...
        if dt_value[0] >= vitesse_max:
            print("valeur max atteint")
        elif current_axes[0] < seuil_joystick_inf:
            dt_value[0] += acceleration

        if dt_value[0] <= vitesse_min:
            print("valeur min atteint")
        elif current_axes[0] > seuil_joystick_sup:
            dt_value[0] -= freinage
...
#moteur avant 
        ...
        if dt_value[2] >= vitesse_max:
            print("valeur max atteint")
        elif current_axes[3] < seuil_joystick_inf:
            dt_value[2] += acceleration

        if dt_value[2] <= vitesse_min:
            print("valeur min atteint")
        elif current_axes[3] > seuil_joystick_sup:
            dt_value[2] -= freinage
